...
func (d *bucket_struct) createFile(fileName string, file multipart.File, ContentType string) {
  ...
  if _, err := io.Copy(wc, file); err != nil {
      fmt.Println("error writing file to buckets")
  }
...
func (d *bucket_struct) readFile(fileName string) {
